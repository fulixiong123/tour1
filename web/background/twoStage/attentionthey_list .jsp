	 ...
	 <div class="main">
          <form target="" action="" name="" class="addresser">
			...
			<table cellspacing="0" cellpadding="0" style="table-layout:fixed;" class="O2">
                <tbody><tr>
                    <td width="2%" class="cbox_td" style="padding:1px 0 1px 7px;">
                    ...
                    <td class="o_title2" style="width:10%;">
                        <a href="#" target="actionFrame">图片</a>
                    </td>
					<td class="o_title2" style="width:10%;">
                        <a href="#" target="actionFrame">标题</a>
                    </td>
					<td class="o_title2" style="width:25%">
                        <a href="#" target="actionFrame">描述</a>
                    </td> 				
                    <td class="o_title2" style="width:5%;">
                    ...
                    <td class="t_title2">
                       <a class="ad_message" href="#"><img src="../images/bg-body.gif" alt="" /></a>
                    </td>
                    <td class="t_title2">
                      我是不是感染了hiv
                    </td>
					<td class="t_title2">
                      我是不是感染了hiv我是不是感染了hiv我是不是感染了hiv我是不是感染了hiv我是不是感染了hiv
					  我是不是感染了hiv我是不是感染了hiv我是不是感染了hiv
                    </td>
                    <td class="t_title2">
                        4月24日
                    </td>
					<td class="t_title2">
                        <a href="attentionthey_manage.jsp">修改</a>
                    </td>
                </tr>
				<tr class="tint1">
