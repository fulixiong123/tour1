                ...
                <div class="usermanage">
                    ...
                    <div class="toolbg toolbgline" style="background-image:none;">
                        <div class="input_left">
                            <input type="button" class="wd1 btn btn_true" value="删除" tabindex="2" onclick="del()"/>
...
<script type="text/javascript">
    angular.module('myApp', []).controller('nameCtrl', function ($scope, $http) {
        var url = "../../api/context/get/dbculture";
        $http.get(url).success(function (response) {
            $scope.dbculture = response;
        });
    });
</script>